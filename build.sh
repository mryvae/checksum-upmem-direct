...
gcc -O3 --std=c99 -o trivial_checksum_example_host_direct_app -I. ./upmemInterface/upmem_direct_c_direct.o  trivial_checksum_example_host.c -g `dpu-pkg-config --cflags --libs dpu` -lstdc++ -lpthread
...
gcc -O3 --std=c99 -o trivial_checksum_example_host_direct_v1_app -I. ./upmemInterface/upmem_direct_c_direct.o  trivial_checksum_example_host1.c -g `dpu-pkg-config --cflags --libs dpu` -lstdc++ -lpthread
